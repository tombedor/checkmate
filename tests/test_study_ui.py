        ...
        "challenges": [
            {
                "id": 1,
                "game_id": "whitegame1",
                "game_url": "https://lichess.org/whitegame1",
                "move_number": 39,
            ...
            },
            {
                "id": 2,
                "game_id": "blackgame2",
                "game_url": "https://lichess.org/blackgame2",
                "move_number": 13,
...
def live_server(sample_output_dir: Path):
    port = _free_port()
    handler = partial(StudyHandler, directory=str(sample_output_dir))
...
def test_study_ui_drag_submit_and_game_link(page):
    ...
    expect(page.locator("#game-link")).to_have_attribute("href", re.compile(r"^https://lichess\.org/.+"))
...
def test_study_ui_click_to_move_and_next(page):
    ...
    expect(page.locator("#game-link")).to_have_attribute("href", "https://lichess.org/blackgame2")
...
def test_study_ui_persists_progress(page):
    page.locator('[data-square="e2"]').click()
    page.locator('[data-square="d4"]').click()
    page.locator("#btn-submit").click()
    ...
    expect(page.locator("#stat-streak")).to_have_text("0")
